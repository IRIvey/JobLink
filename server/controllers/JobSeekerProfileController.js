...
// // To this (if JobSeeker is imported):
...
//     // Create a standardized object to ensure it matches your schema
//     const newExp = {
//       title: body.title,
//       company: body.company || body.companyName,
//       location: body.location,
//       from: body.from || body.startDate,
//       to: body.to || body.endDate,
...
//     // 2. Update Resume Object (Crucial Step)
//     if (!profile.resume) profile.resume = {};
//     if (!profile.resume.workExperience) profile.resume.workExperience = [];
    
//     profile.resume.workExperience.unshift(newExp);
...
//       { 
//         $pull: { 
//           // Removes from the Profile view
//           experience: { _id: experienceId },
//           // Removes from the Resume view
//           "resume.workExperience": { _id: experienceId } 
//         } 
//       },
//       { new: true }
//     );
...
//     // Create a standardized object matching your schema
//     const newEdu = {
//       degree: body.degree,
...
//     // 1. Add to main profile array
//     profile.education.unshift(newEdu);

//     // 2. Add to the resume object (matching resume schema structure)
//     if (!profile.resume) profile.resume = {};
//     if (!Array.isArray(profile.resume.education)) {
//       profile.resume.education = [];
//     }

//     // Create resume-formatted education entry
//     const resumeEdu = {
...
//           // Removes from the Resume view
//           "resume.education": { _id: educationId } 
//         } 
//       },
//       { new: true }
//     );
...
// // ADD Certification
// /**
//  * Adds a professional certification to the user's profile.
//  * Standardizes data fields for professional resume formatting.
//  */
// export const addCertification = async (req, res) => {
//   try {
//     console.log("🔥 HIT profileController addCertification");
//     console.log("ADD CERT BODY of profile:", req.body);
//     console.log("ADD CERT keys:", Object.keys(req.body || {}));
...
//       certificateImageUrl: body.certificateImageUrl || "", // ✅ Store the image URL
//     };
